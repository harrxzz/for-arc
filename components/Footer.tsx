...
export function Footer() {
  return (
    <motion.footer
      ...
      className="relative z-10 border-t border-white/5 mt-20 bg-[color:var(--arc-community-ink)]"
    >
      <div className="max-w-6xl mx-auto px-4 py-8">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            <div className="w-6 h-6 rounded-lg bg-[rgba(47,87,140,0.15)] border border-[rgba(47,87,140,0.20)] flex items-center justify-center">
