        ...
        <div className="divide-y" style={{ borderColor: 'transparent' }}>
          {loading ? (
            <div className="flex items-center justify-center gap-2 py-8">
              <Loader2 size={16} className="text-arc-arc animate-spin" aria-hidden="true" />
              ...
              {swaps.map((tx, i) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-1.5 flex-shrink-0">
                    ...
                    <ExternalLink size={11} className={`${muted} group-hover:text-arc-arc transition-colors`} aria-hidden="true" />
                  </div>
                </motion.a>
              ))}
            </AnimatePresence>
